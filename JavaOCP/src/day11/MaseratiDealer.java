...
public class MaseratiDealer {
	...
	private String deelerLocation="臺中市銷售中心-台中市南屯區文心南路318號";
	...
	public class CarConfiguration{
		...
		public void showItems() {
			System.out.printf("瑪莎拉蒂 %s 銷售中心%n", deelerLocation);
	...
	public static class FinancialService{
		...
		public void showOptions() {
			...
			for(int i=0 ; i<options.length ; i++) {
				System.out.printf("配備 %d - %s%n",(i+1),options[i]);
			}
		}
	}
	...
	public void arrangeTestDrive() {
		final String testDriveProcedure = "標準試駕流程";//最好添加 final
		//方法內部類別 (不能有權限)
		class TestDrive {
