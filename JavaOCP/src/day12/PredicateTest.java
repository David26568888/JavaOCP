...
public class PredicateTest {
	public static void main(String[] args) {
		//利用Predicate 判斷成績是否及格
		Predicate<Double> check =(score)-> score>=60;
		System.out.println(check.test(85.0));
		System.out.println(check.test(45.6));
		
		//練習Consumer+Function+Predicate 應用
