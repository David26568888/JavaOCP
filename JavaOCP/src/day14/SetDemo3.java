...
public class SetDemo3 {
	public static void main(String[] args) {
		...
		dailyTasks.add("06:30 跑3000公尺,客數");
		...
		dailyTasks.add("18:00 打電話給女友，結果打去對方說:正在忙 掛電話(心碎)");
		dailyTasks.add("19:00 晚自習 唱軍歌看影片");
		dailyTasks.add("20:00 洗澡/洗衣服 整理內務");
		dailyTasks.add("21:00 晚點名 玩新兵的時間 體能訓練 做梯次操");
		dailyTasks.add("22:00 聽費玉清晚安曲");
		...
		System.out.println("-----------------");
		dailyTasks.stream().forEach(task->System.out.println(task));
