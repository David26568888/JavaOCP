...
public class SetDemo4 {
	...
	public static void main(String[] args) {
		Set<Task> dailyTasks = new LinkedHashSet<Task>();
		dailyTasks.add(new Task("05:30","起床盥洗"));
		dailyTasks.add(new Task("06:00","早點名"));
		dailyTasks.add(new Task("06:30","跑3000公尺,客數"));
		...
		dailyTasks.add(new Task("18:00","打電話給女友，結果打去對方說:正在忙 掛電話(心碎)"));
		dailyTasks.add(new Task("19:00","晚自習 唱軍歌看影片"));
		...
		System.out.println("13:00".compareTo("12:00")>=0 );//false
		
		// 請幫我列出下午要做的事情13:00~17:59
		System.out.println("--------------");
		for(Task task :dailyTasks) {
			String time = task.getTime();
			//簡單字串比對(13:00~17:59之間)
